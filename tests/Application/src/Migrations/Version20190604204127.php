 ...
 */
final class Version20190604204127 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE gvidasr_channels_group_plugin_channel_group ADD code VARCHAR(250) NOT NULL');
